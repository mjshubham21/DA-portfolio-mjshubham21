...
export function Navigation() {
  ...
  return (
    ...
    // </nav>
    <nav
      className={`fixed top-0 left-0 right-0 z-40 transition-all duration-500 ${isScrolled ? "bg-background/80 backdrop-blur-md border-b border-border/50 shadow-lg" : "bg-transparent"
        }`}
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-2 md:hidden">
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent
                side="right"
                className="w-[80vw] max-w-[350px] bg-background/95 backdrop-blur-md border-l border-border/50"
              >
                <div className="flex flex-col space-y-4 mt-8">
                  <div className="text-center mb-6">
                    <h3 className="text-lg font-semibold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 bg-clip-text text-transparent">
                  ...
                  {navItems.map((item, index) => {
                    ...
                    return (
                      <Link
                        ...
                        className={`flex items-center space-x-3 text-lg font-medium py-3 px-4 rounded-lg transition-all duration-300 group ${isActive
                            ? "bg-primary/20 text-primary shadow-lg shadow-primary/20"
                            : "text-foreground hover:text-primary hover:bg-primary/10"
                          }`}
                        style={{ animationDelay: `${index * 0.1}s` }}
