...
const techIcons = [
  { name: "Python", icon: "🐍", delay: 0, color: "text-yellow-400" },
  { name: "Excel", icon: "📊", delay: 0.2, color: "text-green-400" },
  { name: "MySQL", icon: "🗃️", delay: 0.4, color: "text-blue-400" },
  { name: "Power BI", icon: "📈", delay: 0.6, color: "text-orange-400" },
  { name: "Tableau", icon: "📋", delay: 0.8, color: "text-purple-400" },
  { name: "Pandas", icon: "🐼", delay: 1.0, color: "text-pink-400" },
  { name: "NumPy", icon: "🔢", delay: 1.2, color: "text-cyan-400" },
  { name: "Matplotlib", icon: "📊", delay: 1.4, color: "text-red-400" },
]
...
const IconCard = ({ tech }: { tech: any }) => (
  <motion.div
    ...
    title={tech.name}
  >
    <div className="text-2xl sm:text-4xl relative z-10 filter hover:drop-shadow-lg transition-all duration-300">
      {tech.icon}
    </div>
...
export function HeroSection() {
  ...
  return (
    <section id="hero" className="min-h-screen w-screen flex flex-col items-center justify-center relative overflow-hidden pt-10 sm:pt-16">
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground leading-relaxed">
                Former <span className="text-green-600 dark:text-green-400 font-semibold">MERN Stack Developer</span>{" "}
                now building a career in{" "}
                <span className="text-blue-600 dark:text-blue-400 font-semibold">Data Analytics</span>
              </p>
            </div>
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl">
              Transitioning from web development to data analytics, I combine my technical background with analytical
              thinking to extract meaningful insights from data. Proficient in Python, Excel, MySQL, Power BI, and Tableau.
            </p>
            ...
            <div className="relative w-full h-52 sm:h-72 md:h-80 lg:h-96 flex flex-col items-center justify-center">
              ...
              <div className="absolute inset-0 opacity-10">
                <svg className="w-full h-full" viewBox="0 0 400 400">
                  ...
                  <circle cx="100" cy="100" r="30" fill="none" stroke="currentColor" strokeWidth="2" opacity="0.5" />
                  <circle cx="300" cy="150" r="20" fill="none" stroke="currentColor" strokeWidth="2" opacity="0.3" />
                  <circle cx="200" cy="300" r="25" fill="none" stroke="currentColor" strokeWidth="2" opacity="0.4" />
                  <path d="M50,200 Q200,100 350,250" fill="none" stroke="currentColor" strokeWidth="2" opacity="0.3" />
                  <path d="M100,50 Q250,200 400,150" fill="none" stroke="currentColor" strokeWidth="2" opacity="0.2" />
                </svg>
              </div>
